...
<div class="container">
    ...
    <form action="{{route('detail.update', ['id'=>$tindakan->pasien_id, 'detail_id'=>$tindakan->id])}}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <div class="mb-2">
                        ...
                        <a href="{{ asset('storage/'.$tindakan->foto_sebelum) }}">
                            <img src="{{ asset('storage/'.$tindakan->foto_sebelum) }}" alt="foto sebelum" width="300px">
                        </a>
                        @endif
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="mb-2">
                        ...
                        <a href="{{ asset('storage/'.$tindakan->foto_sesudah) }}">
                            <img src="{{ asset('storage/'.$tindakan->foto_sesudah) }}" alt="foto sesudah" width="300px">
                        </a>
                        @endif
                    </div>
